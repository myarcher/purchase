package com.commodity.purchase.view.load;
...
public class LoadView extends View {
    ...
    private void init(Context context) {
        mMinHeight= mMaxHeight=mMaxWidth=mMinWidth = (int) getResources().getDimension(R.dimen.dimen_70px);
        setIndicator(new BallIndicator());
    }
    ...
    public void setIndicator(Indicator d) {
        if (mIndicator != d) {
            ...
            mIndicator = d;
            mIndicatorColor=getResources().getColor(R.color.main_color);
    ...
    public void setIndicator(String indicatorName){
        ...
        try {
            ...
            Log.e("load","Didn't find your class , check the name again !");
